...
/**********************************************************************************************************************
  4 periodic task(s)
**********************************************************************************************************************/
// Task with name Order66 and a period of 332ms.
void SensorFusion::Order66() {
  // Insert your code for periodic execution here...
}

// Task with name Leaf and a period of 112ms.
void SensorFusion::Leaf() {
  // Insert your code for periodic execution here...
}

// Task with name Methanol and a period of 233ms.
void SensorFusion::Methanol() {
  // Insert your code for periodic execution here...
}

// Task with name Trumpeltier and a period of 152ms.
void SensorFusion::Trumpeltier() {
  // Insert your code for periodic execution here...
