...
p1 = timedelta(milliseconds=60)
p2 = timedelta(milliseconds=70)
p3 = timedelta(milliseconds=5)
p4 = timedelta(milliseconds=22)
p5 = timedelta(milliseconds=23)
...
cd_mod.add_task(vafpy.Task(name="PeriodicTask", period=p1, preferred_offset=0))
...
task1 = vafpy.Task(name="Step1", period=p2, preferred_offset=0)
task2 = vafpy.Task(name="Step2", period=p3, preferred_offset=0)
task3 = vafpy.Task(name="Step3", period=p4, preferred_offset=0)
task4 = vafpy.Task(name="Step4", period=p5, preferred_offset=0, run_after=[task3])
