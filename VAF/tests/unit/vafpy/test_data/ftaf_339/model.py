...
from vaf import BaseTypes, Executable, save_main_model, vafpy
...
od_list = vafpy.datatypes.Vector(
    name="ObjectDetectionList", namespace="adas::interfaces", datatype=object_detection
)
...
AdasDemoApp.executable = Executable("adas_demo_app", p_10ms)
AdasDemoApp.executable.add_application_module(cd_mod, [("PeriodicTask", timedelta(milliseconds=1), 1)])
